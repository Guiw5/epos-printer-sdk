...
export type BarcodeType = 'upc_a' | 'upc_e' | 'ean13' | 'jan13' | 'ean8' | 'jan8' | 'code39' |
                   'itf' | 'codabar' | 'code93' | 'code128' | 'code128_auto' | 'gs1_128' |
...
export type Pattern = 'none' | 'pattern_0' | 'pattern_1' | 'pattern_2' | 'pattern_3' | 'pattern_4' |
               'pattern_5' | 'pattern_6' | 'pattern_7' | 'pattern_8' | 'pattern_9' | 'pattern_10' | 'pattern_a' |
               'pattern_b' | 'pattern_c' | 'pattern_d' | 'pattern_e' | 'error' | 'paper_end';
